...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mVarietas.setText(pets.get(position).getVarietas());
        holder.mNo_soliter.setText(pets.get(position).getNo_soliter());
        holder.mTgl_pembelian.setText(pets.get(position).getTgl_pembelian());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView mVarietas, mNo_soliter, mTgl_pembelian;
        ...
        public MyViewHolder(View itemView, RecyclerViewClickListener listener) {
            ...
            mVarietas = itemView.findViewById(R.id.varietas);
            mNo_soliter = itemView.findViewById(R.id.no_soliter);
            mLove = itemView.findViewById(R.id.love);
            mTgl_pembelian = itemView.findViewById(R.id.tgl_pembelian);
